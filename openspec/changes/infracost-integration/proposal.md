...
- Deployment and production approval remain governed by CloudFormation change sets and existing environment controls; cost estimation is an additional pre-deployment review and policy signal.
